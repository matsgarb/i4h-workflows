...
@configclass
class TissueRetractionSceneCfg(InteractiveSceneCfg):
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        mode="reset",
        params={"asset_cfg": SceneEntityCfg("object"),"velocity_range": {},"position_range": {"x": (-0.03, 0.03), "y": (-0.03, 0.03), "z": (0.0, 0.0)},}, 
        # params={"pose_range": {"x": (-0.03, 0.03), "y": (-0.03, 0.03), "z": (0.0, 0.0)},"velocity_range": {},"asset_cfg": SceneEntityCfg("object"),},
    )
...
@configclass
class TissueRetractionEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the tissue retraction environment."""

    # Scene settings
    scene: TissueRetractionSceneCfg = TissueRetractionSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
