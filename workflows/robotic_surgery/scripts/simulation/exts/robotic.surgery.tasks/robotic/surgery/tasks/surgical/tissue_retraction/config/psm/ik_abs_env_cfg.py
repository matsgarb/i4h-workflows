...
@configclass
class PSMTissueRetractionEnvCfg(joint_pos_env_cfg.PSMTissueRetractionEnvCfg):
    def __post_init__(self):
        ...
        # self.actions.arm_action = DifferentialInverseKinematicsActionCfg( vecchio
        self.actions.body_joint_pos = DifferentialInverseKinematicsActionCfg( # nuovo
            asset_name="robot",
            joint_names=[
                "psm_yaw_joint",
                "psm_pitch_end_joint",
